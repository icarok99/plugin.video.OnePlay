...
# URLs do repositório
RAW_BASE_URL = 'https://raw.githubusercontent.com/icarok99/plugin.video.OnePlay/main/'
CONTENTS_API_URL = 'https://api.github.com/repos/icarok99/plugin.video.OnePlay/contents/'

def notify(msg):
    xbmcgui.Dialog().notification('ONEPLAY - Update', msg, xbmcgui.NOTIFICATION_INFO, 4000)
